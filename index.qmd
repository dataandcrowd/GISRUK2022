...
- Probability that any two randomly selected species from the sample will be different
   - 0: Low diversity (tends to be domestic)
   - 1: High diversity
- **N**: Total Number of Individual Organisms
- **n**: Number of individuals at particular species
...
::: {.column width="50%"}
![](images/simpsonex1.png){.absolute top="150" left="0" width="400" height="350"}
:::
...
::: {.column width="50%"}
![](images/simpsonex2.png){.absolute top="150" left="0" width="400" height="350"}
:::
...
- However, such variabilities can be identified by the disaggregation of gender and age
    * Men between 20s-50s & Women in 20s: Max of 150 countries, Mean of 40 countries
...
- OSM can be used as a proxy to understand the uneven spatial coverage of "the crowd"
:::
